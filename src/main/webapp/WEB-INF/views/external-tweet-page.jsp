...
<link rel="stylesheet" type="text/css"
	href="/endavainternship/resources/css/stanley/css/bootstrap.css" />


<!-- Custom styles for this template -->

<link href="/endavainternship/resources/css/stanley/css/main.css" rel="stylesheet">
<link href="/endavainternship/resources/css/stanley/css/displayTweets.css"
	rel="stylesheet">
<link href="/endavainternship/resources/css/stanley/css/iphone.css" rel="stylesheet">
<link href="/endavainternship/resources/css/stanley/css/paginate.css" rel="stylesheet">
...
<script src="/endavainternship/resources/css/stanley/js/charCount.js"></script>
...
<div class="container">
	...
	<div class="row">
		...
		<h1 align="center">User Profile</h1>
			 <img src="/images/${currentUser.imageName}" alt="Stanley" width="250" height="250" class="avatar">
					<h1>${currentUser.firstname} ${currentUser.lastname}</h1>
					<p>Hello everybody. I'm ${currentUser.firstname}
						${currentUser.lastname} , you can follow me !</p>
...
<!-- /container -->
	...
	<div id="footer">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4">
					<img src="/endavainternship/resources/css/stanley/img/bird.png"  class ="bird">
	...
	<script src="/endavainternship/resources/css/stanley/js/bootstrap.min.js"></script>
</body>
</html>